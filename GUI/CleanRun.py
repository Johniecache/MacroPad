...
if __name__ == "__main__":
    ...
    gui_folder = os.path.join(project_root) # set the gui folder to the project root
    ...
    subprocess.run(["python", os.path.join(gui_folder, "MacroPadGUI.py")]) # run "MacroPadGUI.py" as a new python process
